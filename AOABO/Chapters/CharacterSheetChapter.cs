        ...
        protected override string GetPartSubFolder()
        {
            if (Configuration.Options.Extras.CharacterSheets == CharacterSheets.All)
            {
                return Volume switch
                {
                    ...
                    "0501" or "0502" or "0503" or "0504" => $"{Configuration.FolderNames["PartFive"]}\\03-Story",
            ...
            return Volume switch
            {
                ...
                "0501" or "0502" or "0503" or "0504" => $"{Configuration.FolderNames["PartFive"]}",
                _ => throw new Exception($"GetPartSubFolder - {ChapterName}"),
            };
        }
        ...
        protected override string GetVolumeSubFolder()
        {
            if (Configuration.Options.Extras.CharacterSheets == CharacterSheets.All)
            {
                return Volume switch
                {
                    ...
                    "0501" or "0502" or "0503" or "0504" => $"{Configuration.FolderNames["PartFive"]}\\{Volume}-{getVolumeName()}",
