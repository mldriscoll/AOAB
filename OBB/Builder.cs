...
namespace OBB
{
    public static class Builder
    {
        ...
        private static List<JSON.Chapter> BuildChapterList(Volume volume, Func<JSON.Chapter, bool> filter)
        {
            var ret = new List<JSON.Chapter>();
        ...
        private static IEnumerable<JSON.Chapter> ProcessChapter(JSON.Chapter chapter, Func<JSON.Chapter, bool> filter)
        {
